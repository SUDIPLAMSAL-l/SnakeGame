...
public class GamePanel extends JPanel implements Runnable, KeyListener
{
	...
	public void keyPressed(KeyEvent e)
	{
		...
		if(k == KeyEvent.VK_SPACE&&gameover==true) setUplevel();
	}
	@Override 
	...
	public void render(Graphics2D g2d)
	{
		...
		if(gameover){g2d.drawString("GameOver!" , 450, 280);}
		g2d.setColor(Color.green);
		g2d.setFont(new Font("Ink free", Font.BOLD, 25));
		if(gameover){g2d.drawString("Space fo restart" , 415, 380);}
		g2d.setColor(Color.white);
		if(gameover)g2d.drawString(" level : " + level, 390, 330);
		if(gameover)g2d.drawString("Score : " + score, 520, 330);
		g2d.setColor(Color.white);
		if(!(gameover)) {g2d.drawString("Score : " + score, 870, 30);}
		if(!(gameover)) {g2d.drawString(" level : " + level, 0, 30);}
		if(dx == 0 && dy == 0){g2d.drawString("Let`s play!", 470, 280);}
	}
	@Override
